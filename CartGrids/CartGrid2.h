...
//! @tparam Container the type of object stored in a bin
//--------------------------------------------------------------------------------
...
public:
  ...
  //--------------------------------------------------------------------------------
  CartGrid2(const GridDef& xGridDef, const GridDef& yGridDef, const GridDef& zGridDef);
  ...
  //--------------------------------------------------------------------------------
  int32_t addEntry(const XyzPosCoords& pos, const SmartEntry& entry);

  //--------------------------------------------------------------------------------
  //! @brief Removes an Entry from the grid
  //! @param[in] smartEntry The entry to be removed
  //! @none The bin number in which the Entry was inserted
  //--------------------------------------------------------------------------------
  void removeEntry(const SmartEntry& smartEntry);
  ...
  //--------------------------------------------------------------------------------
  const std::vector<SmartEntry>& getEntriesByPos(const XyzPosCoords& pos);
  ...
  //--------------------------------------------------------------------------------
  const std::vector<SmartEntry>& getEntriesBySearchExtent(const XyzPosCoords& refPos, const XyzPosCoords& searchExtent);
...
private:
  ...
  //! The mutex that prevents multi-threaded data races on this object
